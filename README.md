...
- 小月度汇总按结束月份归档：例如 `2026-04-14` 到 `2026-05-14` 算 `2026-05` 小月度汇总；`2026-05-15` 起进入 `2026-06` 小月度汇总。
- 月度汇总也按结束月份归档：例如 `2026-04-23` 到 `2026-05-23` 算 `2026-05` 月度汇总；`2026-05-24` 起进入 `2026-06` 月度汇总。
